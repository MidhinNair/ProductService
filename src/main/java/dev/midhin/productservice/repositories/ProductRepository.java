...
//    List<Product> findAllByCategoryIn(List<UUID> uuids);
    ...
    List<Product> findAllByTitle(String midhin);

//    @Query("select Product from Product where Product.price.currency = :currency and Product.title = :midhin")
//    List<Product> doSomething(String midhin, String currency);
}
