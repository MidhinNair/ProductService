package dev.midhin.productservice.controllers;

import dev.midhin.productservice.dtos.GenericProductDto;
import dev.midhin.productservice.exceptions.NotFoundException;
import dev.midhin.productservice.services.FakeStoreProductService;
import dev.midhin.productservice.services.ProductService;
import dev.midhin.productservice.thirdpartyclients.productsservice.fakestore.FakeStoryProductServiceClient;
...
//
//    @Test
//    void shouldReturnTitlemidhinWithProductID1() throws NotFoundException {
//        GenericProductDto genericProductDto = new GenericProductDto();
//        genericProductDto.setTitle("midhin");
//        when(
...
//        assertEquals("midhin", genericProductDto1.getTitle());
//    }
//
//    @Test
